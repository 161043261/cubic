...
def gen_cmd_naive(w, a, v, total, ratio, index_path):
    cmd = './build/nicolas -w {} -a {} -m {} --number-of-queries {} -r {} -c {} -i {} -n {} -v {} --fence-pointer no > dat_tmp_zipf/figure_{}_{}_raw_w_{}_ratio_{}.dat'.format(
...
def gen_cmd_others(w, a, v, total, ratio, index_path):
    cmd = './build/nicolas -w {} -a {} -m {} --number-of-queries {} -r {} -c {} -i {} -n {} -v {} --fence-pointer yes --fence-length 100000 > dat_tmp_zipf/figure_{}_{}_raw_w_{}_ratio_{}.dat'.format(
        w, a, mode, int(total * (1 - ratio)), int(total * ratio), cardinality, index_path, number_of_rows, v, a,
        'latency' if (v == 'yes') else 'throughput', w, ratio)
    return cmd
...
def gen_cmd_naive_cardinality(w, a, v, total, ratio, index_path, c, n):
    cmd = './build/nicolas -w {} -a {} -m {} --number-of-queries {} -r {} -c {} -i {} -n {} -v {} --fence-pointer no > dat_tmp_zipf/figure_{}_{}_raw_w_{}_ratio_{}_c_{}.dat'.format(
...
def gen_cmd_others_cardinality(w, a, v, total, ratio, index_path, c, n):
    cmd = './build/nicolas -w {} -a {} -m {} --number-of-queries {} -r {} -c {} -i {} -n {} -v {} --fence-pointer yes --fence-length 100000 > dat_tmp_zipf/figure_{}_{}_raw_w_{}_ratio_{}_c_{}.dat'.format(
        w, a, mode, int(total * (1 - ratio)), int(total * ratio), c, index_path, n, v, a,
        'latency' if (v == 'yes') else 'throughput', w, ratio, c)
    return cmd
...
def gen_figure_naive_throughput_core():
    ...
    for num in core_number:
        ...
        ret = throughput_analysis(
            'dat_tmp_zipf/figure_naive_throughput_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_naive_throughput_cardinality():
    ...
    for num in cardinality_number:
        ...
        os.system(cmd)
        ret = throughput_analysis(
            'dat_tmp_zipf/figure_naive_throughput_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality,
...
def gen_figure_naive_latency_cardinality():
    ...
    for num in cardinality_number:
        ...
        ret = latency_analysis(
            'dat_tmp_zipf/figure_naive_latency_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality,
                                                                                  ratio_percentage, num))
        print(ret)
        print('\n')
        for i in range(0, len(ret)):
...
def gen_figure_ucb_throughput_core():
    ...
    for num in core_number:
        ...
        os.system(cmd)
        ret = throughput_analysis(
            'dat_tmp_zipf/figure_ucb_throughput_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_ucb_throughput_cardinality():
    ...
    for num in cardinality_number:
        ...
        os.system(cmd)
        ret = throughput_analysis(
            'dat_tmp_zipf/figure_ucb_throughput_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality,
                                                                                   ratio_percentage, num))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
...
def gen_figure_ucb_latency_cardinality():
    ...
    for num in cardinality_number:
        ...
        os.system(cmd)
        ret = latency_analysis(
            'dat_tmp_zipf/figure_ucb_latency_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality, ratio_percentage,
                                                                                num))
        print(ret)
        print('\n')
        for i in range(0, len(ret)):
...
def gen_figure_ub_throughput_core():
    ...
    for num in core_number:
        ...
        os.system(cmd)
        ret = throughput_analysis(
            'dat_tmp_zipf/figure_ub_throughput_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_ub_throughput_cardinality():
    ...
    for num in cardinality_number:
        ...
        os.system(cmd)
        ret = throughput_analysis(
            'dat_tmp_zipf/figure_ub_throughput_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality,
                                                                                  ratio_percentage, num))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
...
def gen_figure_ub_latency_cardinality():
    ...
    for num in cardinality_number:
        ...
        os.system(cmd)
        ret = latency_analysis(
            'dat_tmp_zipf/figure_ub_latency_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality, ratio_percentage,
                                                                               num))
        print(ret)
        print('\n')
        for i in range(0, len(ret)):
...
def gen_figure_cubit_lk_throughput_core():
    ...
    for num in core_number:
        ...
        os.system(cmd)
        ret = throughput_analysis(
            'dat_tmp_zipf/figure_cubit-lk_throughput_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_cubit_lk_throughput_cardinality():
    ...
    for num in cardinality_number:
        index_path = "100M_{}".format(num)
        cmd = gen_cmd_others_cardinality(core_for_cardinality, 'cubit-lk', 'no', 1000, ratio_percentage, index_path,
                                         num, ONE_HUNDRED_MILLION)
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis(
            'dat_tmp_zipf/figure_cubit-lk_throughput_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality,
                                                                                        ratio_percentage, num))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
...
def gen_figure_cubit_lk_latency_core():  # latency
    ...
    for num in core_number:
        ...
        os.system(cmd)
        ret = latency_analysis(
            'dat_tmp_zipf/figure_cubit-lk_latency_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        for i in range(0, len(ret)):
            f.write('{} {} \n'.format(num, ret[i]))
...
def gen_figure_cubit_lk_latency_cardinality():
    ...
    for num in cardinality_number:
        index_path = "100M_{}".format(num)
        cmd = gen_cmd_others_cardinality(core_for_cardinality, 'cubit-lk', 'yes', 1000, ratio_percentage, index_path,
                                         num, ONE_HUNDRED_MILLION)
        print(cmd)
        os.system(cmd)
        ret = latency_analysis(
            'dat_tmp_zipf/figure_cubit-lk_latency_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality,
                                                                                     ratio_percentage, num))
        print(ret)
        print('\n')
        for i in range(0, len(ret)):
...
def gen_figure_cubit_lf_throughput_core():
    ...
    for num in core_number:
        ...
        os.system(cmd)
        ret = throughput_analysis(
            'dat_tmp_zipf/figure_cubit-lf_throughput_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_cubit_lf_throughput_cardinality():
    ...
    for num in cardinality_number:
        index_path = "100M_{}".format(num)
        cmd = gen_cmd_others_cardinality(core_for_cardinality, 'cubit-lf', 'no', 1000, ratio_percentage, index_path,
                                         num, ONE_HUNDRED_MILLION)
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis(
            'dat_tmp_zipf/figure_cubit-lf_throughput_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality,
                                                                                        ratio_percentage, num))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
...
def gen_figure_cubit_lf_latency_core():  # latency
    ...
    for num in core_number:
        ...
        os.system(cmd)
        ret = latency_analysis(
            'dat_tmp_zipf/figure_cubit-lf_latency_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        for i in range(0, len(ret)):
            f.write('{} {} \n'.format(num, ret[i]))
...
def gen_figure_cubit_lf_latency_cardinality():
    ...
    for num in cardinality_number:
        index_path = "100M_{}".format(num)
        cmd = gen_cmd_others_cardinality(core_for_cardinality, 'cubit-lf', 'yes', 1000, ratio_percentage, index_path,
                                         num, ONE_HUNDRED_MILLION)
        print(cmd)
        os.system(cmd)
        ret = latency_analysis(
            'dat_tmp_zipf/figure_cubit-lf_latency_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality,
                                                                                     ratio_percentage, num))
        print(ret)
        print('\n')
        for i in range(0, len(ret)):
...
def main():
    ...
    cmd3 = "cp run_zipf.sh graphs_zipf"
    ...
    while itr < 3:
        ...
        if (os.path.isfile("zipf_15")):
            ...
            os.system("python3 eva-scripts/gen_zipf.py")
