...
#     'latency_output_cubit-lf'    :   'dat_tmp/figure_cubit-lf_latency_raw_w_32_ratio_0.1_c_32.dat',
...
file_map = {
    ...
    'latency_output_cubit-lf': 'dat_tmp/figure_cubit-lf_latency_raw_w_16_ratio_0.1_c_32.dat',
...
def figure_Q():
    # plt.subplots_adjust(top = 0.5,bottom = 0.05,right = 0.99,left = 0.095)
    ...
    if fig == 0:
        ...
        plt.savefig(dir + '/graphs/cdf_Q.png', format='png', dpi=1200)
        plt.savefig(dir + '/graphs/cdf_Q.eps', format='eps', dpi=1200)
...
def figure_UID():
    ...
    if fig == 0:
        ...
        plt.savefig(dir + '/graphs/cdf_UID.png', format='png', dpi=1200)
        plt.savefig(dir + '/graphs/cdf_UID.eps', format='eps', dpi=1200)
...
#         plt.show()
#     else:
#         plt.savefig(dir + '/graphs/cdf_Q_ub+cubit-lk+cubit-lf.png', format='png', dpi=1200)
#         plt.savefig(dir + '/graphs/cdf_Q_ub+cubit-lk+cubit-lf.eps', format='eps', dpi=1200)
...
#         plt.show()
#     else:
#         plt.savefig(dir + '/graphs/cdf_UID_ub+cubit-lk+cubit-lf.png', format='png', dpi=1200)
#         plt.savefig(dir + '/graphs/cdf_UID_ub+cubit-lk+cubit-lf.eps', format='eps', dpi=1200)
