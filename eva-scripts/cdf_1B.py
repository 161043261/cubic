...
def check(exp_name):
    ...
    print("# items:", len(content), "    Min:", min(content), "     Max:", max(content), "    Mean:",
          stati.mean(content))
...
# file_map
file_map = {
    'latency_output_naive': 'dat_tmp_1B/figure_naive_latency_raw_w_32_ratio_0.1.dat',
    'latency_output_cubit-lk': 'dat_tmp_1B/figure_cubit-lk_latency_raw_w_32_ratio_0.1.dat',
    'latency_output_cubit-lf': 'dat_tmp_1B/figure_cubit-lf_latency_raw_w_32_ratio_0.1.dat',
    'latency_output_ub': 'dat_tmp_1B/figure_ub_latency_raw_w_32_ratio_0.1.dat',
    'latency_output_ucb': 'dat_tmp_1B/figure_ucb_latency_raw_w_32_ratio_0.1.dat'
}
...
def figure_Q():
    ...
    plt.ylim(0, 1)
    plt.xlabel("Query Response Time (ms)", fontsize='15')
    ...
    if fig == 0:
        ...
        plt.savefig(dir + '/graphs_1B/cdf_Q.png', format='png', dpi=1200)
        plt.savefig(dir + '/graphs_1B/cdf_Q.eps', format='eps', dpi=1200)
...
def figure_UID():
    ...
    plt.ylim(0, 1)
    plt.xlabel("Update/Insert/Delete Response Time (ms)", fontsize='15')
    plt.ylabel("Cumulative Fraction", fontsize='15')
    legend = ax.legend(loc='lower right', shadow=True, fontsize='15')
    plt.tick_params(labelsize=14)
    plt.tight_layout()
    ...
    if fig == 0:
        ...
        plt.savefig(dir + '/graphs_1B/cdf_UID.eps', format='eps', dpi=1200)
        plt.savefig(dir + '/graphs_1B/cdf_UID.png', format='png', dpi=1200)
...
def figure_Q_2():  # for ub cubit cubit-lf
    ...
    if fig == 0:
        ...
        plt.savefig(dir + '/graphs_1B/cdf_Q_ub+cubit-lk+cubit-lf.png', format='png', dpi=1200)
        plt.savefig(dir + '/graphs_1B/cdf_Q_ub+cubit-lk+cubit-lf.eps', format='eps', dpi=1200)
...
def figure_UID_2():  # for ub cubit cubit-lf
    ...
    if fig == 0:
        ...
        plt.savefig(dir + '/graphs_1B/cdf_UID_ub+cubit-lk+cubit-lf.png', format='png', dpi=1200)
        plt.savefig(dir + '/graphs_1B/cdf_UID_ub+cubit-lk+cubit-lf.eps', format='eps', dpi=1200)
