...
def figure():
    ...
    for file_name in experiments_1:
        ...
        ax1.plot(sorted_data2, yvals, label=nm_map_1[file_name], ls=ls_map_1[file_name], color=co_map_1[file_name],
                 lw=2)
    ...
    for file_name in experiments_2:
        ...
        ax2.plot(Noc, Throughput, label=nm_map_2[file_name], ls=ls_map_2[file_name], color=co_map_2[file_name],
                 marker=line_marker[file_name], mfc='w', ms=11, lw='2')
