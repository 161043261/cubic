...
if not os.path.exists("Land_and_Ocean_EqualArea.nc"):
    os.system(
        "wget https://berkeley-earth-temperature.s3.us-west-1.amazonaws.com/Global/Gridded/Land_and_Ocean_EqualArea.nc")
