...
template
class ibis::fileManager::buffer<char>;

template
class ibis::fileManager::buffer<signed char>;

template
class ibis::fileManager::buffer<unsigned char>;

template
class ibis::fileManager::buffer<float>;

template
class ibis::fileManager::buffer<double>;

template
class ibis::fileManager::buffer<int16_t>;

template
class ibis::fileManager::buffer<uint16_t>;

template
class ibis::fileManager::buffer<int32_t>;

template
class ibis::fileManager::buffer<uint32_t>;

template
class ibis::fileManager::buffer<int64_t>;

template
class ibis::fileManager::buffer<uint64_t>;
