    ...
    while (*str != 0) {
        ...
        if (type.compare(0, 8, "unsigned") == 0) {
            ...
            switch (*(next)) {
                case 'b':
                case 'B':
                    addColumn(nm.c_str(), ibis::UBYTE);
                    break;
                case 's':
                case 'S':
                    addColumn(nm.c_str(), ibis::USHORT);
                    break;
                case 'i':
                case 'I':
                    addColumn(nm.c_str(), ibis::UINT);
                    break;
                case 'l':
                case 'L':
                    addColumn(nm.c_str(), ibis::ULONG);
                    break;
                default:
                    LOGGER(ibis::gVerbose > 1)
            ...
            switch (type[0]) {
                ...
                case 'i':
                case 'I':
                    addColumn(nm.c_str(), ibis::INT);
                    break;
                case 'l':
                case 'L':
                    addColumn(nm.c_str(), ibis::LONG);
                    break;
                case 'v':
                case 'V':
                    addColumn(nm.c_str(), ibis::ULONG);
                ...
                case 'f':
                case 'F':
                    addColumn(nm.c_str(), ibis::FLOAT);
                    break;
                case 'd':
                case 'D':
                    addColumn(nm.c_str(), ibis::DOUBLE);
                    break;
                case 'c':
                case 'C':
                case 'k':
                case 'K':
                    addColumn(nm.c_str(), ibis::CATEGORY);
                    break;
                case 't':
                case 'T':
