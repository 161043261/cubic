...
#pragma
warning(disable:4786)    // some identifier longer than 256 characters
#endif

#include
"blob.h"    // ibis::blob
#include
"category.h"    // ibis::text, ibis::category, ibis::column
#include
"query.h"
#include
"countQuery.h"    // ibis::countQuery
#include
"iroster.h"
#include
"twister.h"    // ibis::MersenneTwister
...
#if
defined(HAVE_DIRENT_H) || defined(__unix__) || defined(__HOS_AIX__)    \
...
#if
(defined(HAVE_VPRINTF) || defined(_WIN32)) && ! defined(DISABLE_VPRINTF)
...
#if
(defined(__unix__) && !defined(__CYGWIN__) && !(defined(__sun) && defined(__GNUC__) && __GNUC__ <= 2)) || defined(__HOS_AIX__)
...
#if
defined(__unix__) || defined(__linux__) || defined(__HOS_AIX__) || defined(__APPLE__) || defined(__FreeBSD__)
...
#elif
defined(__unix__) || defined(__HOS_AIX__)
ierr = pthread_attr_setdetachstate(&tattr, PTHREAD_CREATE_DETACHED);
if (ierr
#if
defined(ENOTSUP)
...
#if
defined(HAVE_DIRENT_H) || defined(__unix__) || defined(__HOS_AIX__) || defined(__APPLE__) || defined(_XOPEN_SOURCE) || defined(_POSIX_C_SOURCE)
