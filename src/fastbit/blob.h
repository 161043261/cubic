...
public:
    ...
    selectBytes(const bitvector &) const {
        return 0;
    }

    virtual array_t<unsigned char> *
    selectUBytes(const bitvector &) const {
        return 0;
    }

    virtual array_t<int16_t> *
    selectShorts(const bitvector &) const {
        return 0;
    }

    virtual array_t<uint16_t> *
    selectUShorts(const bitvector &) const {
        return 0;
    }

    virtual array_t<int32_t> *
    selectInts(const bitvector &) const {
        return 0;
    }

    virtual array_t<uint32_t> *
    selectUInts(const bitvector &) const {
        return 0;
    }

    virtual array_t<int64_t> *
    selectLongs(const bitvector &) const {
        return 0;
    }

    virtual array_t<uint64_t> *
    selectULongs(const bitvector &) const {
        return 0;
    }

    virtual array_t<float> *
    selectFloats(const bitvector &) const {
        return 0;
    }

    virtual array_t<double> *
    selectDoubles(const bitvector &) const {
        return 0;
    }

    virtual std::vector<std::string> *
    selectStrings(const bitvector &) const {
        return 0;
    }
