...
public:
    ...
    void swap(colBytes &rhs) { // swap two colBytes
        ...
        rhs.col = col;
        col = c;
        array_t<signed char> *a = rhs.array;
        rhs.array = array;
        array = a;
    }
...
public:
    ...
    void swap(colUBytes &rhs) { // swap two colUBytes
        ...
        rhs.col = col;
        col = c;
        array_t<unsigned char> *a = rhs.array;
        rhs.array = array;
        array = a;
    }
...
public:
    ...
    void swap(colStrings &rhs) { // swap two colStrings
        ...
        rhs.col = col;
        col = c;
        std::vector<std::string> *a = rhs.array;
        rhs.array = array;
        array = a;
    }
...
public:
    ...
    void swap(colBlobs &rhs) { // swap two colBlobs
        ...
        rhs.col = col;
        col = c;
        std::vector<ibis::opaque> *a = rhs.array;
        rhs.array = array;
        array = a;
    }
