...
public:
    ...
    virtual qContinuousRange *dup() const {
        return new qContinuousRange(*this);
    }
...
public:
    ...
    virtual qDiscreteRange *dup() const {
        return new qDiscreteRange(*this);
    }
...
/// Types of terms allowed in the mathematical expressions.
        enum TERM_TYPE {
            UNDEF_TERM, VARIABLE, NUMBER, STRING, OPERATOR,
...
/// A variable.
        ...
        public:
            ...
            const char *getDecoration() const {
                return decor.c_str();
            }
