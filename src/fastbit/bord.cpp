...
#include
"tab.h"    // ibis::tabula and ibis::tabele
#include
"bord.h"    // ibis::bord
#include
"query.h"    // ibis::query
...
#include
"bundle.h"    // ibis::bundle
#include
"ikeywords.h"    // ibis::keyword::tokenizer
#include
"blob.h"    // printing ibis::opaque
...
#include
<algorithm>    // std::reverse, std::copy
...
"vals.size(" << vals.size() << ") and idxin.size("
<< idxin.size()
