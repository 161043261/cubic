...
int ibis::util::copy(const char *to, const char *from) {
    ...
    char *buf = 0;
    try {
        buf = new char[nbuf];   // try hard to allocate some space for buf
    }
...
void ibis::util::int2string(std::string &str, unsigned v1, unsigned v2,
    ...
    char name[17];
    name[16] = (char) 0;
    name[15] = ibis::util::charTable[63 & v3];
    v3 >>= 6;
    name[14] = ibis::util::charTable[63 & v3];
    v3 >>= 6;
    name[13] = ibis::util::charTable[63 & v3];
    v3 >>= 6;
    name[12] = ibis::util::charTable[63 & v3];
    v3 >>= 6;
    name[11] = ibis::util::charTable[63 & v3];
    v3 >>= 6;
    name[10] = ibis::util::charTable[63 & (v3 | (v2 << 2))];
    v2 >>= 4;
    name[9] = ibis::util::charTable[63 & v2];
    v2 >>= 6;
    name[8] = ibis::util::charTable[63 & v2];
    v2 >>= 6;
    name[7] = ibis::util::charTable[63 & v2];
    v2 >>= 6;
    name[6] = ibis::util::charTable[63 & v2];
    v2 >>= 6;
    name[5] = ibis::util::charTable[63 & (v2 | (v1 << 4))];
    v1 >>= 2;
    name[4] = ibis::util::charTable[63 & v1];
    v1 >>= 6;
    name[3] = ibis::util::charTable[63 & v1];
    v1 >>= 6;
    name[2] = ibis::util::charTable[63 & v1];
    v1 >>= 6;
    name[1] = ibis::util::charTable[63 & v1];
    v1 >>= 6;
...
void ibis::util::int2string(std::string &str, unsigned v1, unsigned v2) {
    char name[12];
    name[11] = (char) 0;
    name[10] = ibis::util::charTable[15 & v2];
    v2 >>= 4;
    name[9] = ibis::util::charTable[63 & v2];
    v2 >>= 6;
    name[8] = ibis::util::charTable[63 & v2];
...
void ibis::util::int2string(std::string &str, unsigned val) {
    char name[7];
    name[6] = (char) 0;
    name[5] = ibis::util::charTable[3 & val];
    val >>= 2;
    name[4] = ibis::util::charTable[63 & val];
    val >>= 6;
    name[3] = ibis::util::charTable[63 & val];
    val >>= 6;
    name[2] = ibis::util::charTable[63 & val];
    val >>= 6;
    name[1] = ibis::util::charTable[63 & val];
    val >>= 6;
...
int ibis::util::decode64(uint64_t &output, const std::string &buf) {
    ...
    if (buf.empty() || buf.size() > 11 ||
        (buf.size() == 11 && ibis::util::charIndex[(unsigned) buf[10]] >= 16))
        return -1;
