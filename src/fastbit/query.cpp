...
ibis::query::QUERY_STATE ibis::query::getState() const {
    if (ibis::gVerbose > 6) {
        switch (state) {
            case UNINITIALIZED:
                logMessage("getState", "UNINITIALIZED");
                break;
            case SET_RIDS:
                logMessage("getState", "SET_RIDS");
                break;
            case SET_COMPONENTS:
                logMessage("getState", "SET_COMPONENTS");
                break;
            case SET_PREDICATE:
                logMessage("getState", "SET_PREDICATE");
                break;
            case SPECIFIED:
                logMessage("getState", "SPECIFIED");
                break;
            case QUICK_ESTIMATE:
                logMessage("getState", "QUICK_ESTIMATE");
                break;
            case FULL_EVALUATE:
                logMessage("getState", "FULL_EVALUATE");
                break;
            default:
...
char *ibis::query::newToken(const char *uid) {
    ...
    name[15] = ibis::util::charTable[63 & tc];
    tc >>= 6;
    name[14] = ibis::util::charTable[63 & tc];
    tc >>= 6;
    name[13] = ibis::util::charTable[63 & tc];
    tc >>= 6;
    name[12] = ibis::util::charTable[63 & tc];
    tc >>= 6;
    name[11] = ibis::util::charTable[63 & tc];
    tc >>= 6;
    name[10] = ibis::util::charTable[63 & (tc | (tb << 2))];
    tb >>= 4;
    name[9] = ibis::util::charTable[63 & tb];
    tb >>= 6;
    name[8] = ibis::util::charTable[63 & tb];
    tb >>= 6;
    name[7] = ibis::util::charTable[63 & tb];
    tb >>= 6;
    name[6] = ibis::util::charTable[63 & tb];
    tb >>= 6;
    name[5] = ibis::util::charTable[63 & (tb | (ta << 4))];
    ta >>= 2;
    name[4] = ibis::util::charTable[63 & ta];
    ta >>= 6;
    name[3] = ibis::util::charTable[63 & ta];
    ta >>= 6;
    name[2] = ibis::util::charTable[63 & ta];
    ta >>= 6;
    name[1] = ibis::util::charTable[63 & ta];
    ta >>= 6;
